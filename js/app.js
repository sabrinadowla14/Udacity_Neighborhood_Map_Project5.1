...
var Restaurant = function(data) {
    ...
    var wikiRequestTimeout = setTimeout(function() {
        var msg = 'Could not get Wikipedia resourses, Please click this link: <a href="';
        var link = 'https://en.wikipedia.org/wiki/';
        self.wikiSnippet = (msg + link + data.name + '" target="_blank">' + data.name + '</a>');
    }, 2000);
    ...
    //wikiUrl = 'https://en.wikipeeeeeeeeeeeeeedia.org/w/api.php?action=opensearch&search=' + data.name + '&srproperties=snippet&format=json&callback=wikiCallback';
    $.ajax({
        url: wikiUrl,
        dataType: 'jsonp',
